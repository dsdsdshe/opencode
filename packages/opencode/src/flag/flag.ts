...
export namespace Flag {
  ...
  export const OPENCODE_SAFE_MODE = truthy("OPENCODE_SAFE_MODE")
  export const OPENCODE_DISABLE_AUTOUPDATE = truthy("OPENCODE_DISABLE_AUTOUPDATE")
  export const OPENCODE_DISABLE_PRUNE = truthy("OPENCODE_DISABLE_PRUNE")
  export const OPENCODE_DISABLE_TERMINAL_TITLE = truthy("OPENCODE_DISABLE_TERMINAL_TITLE")
  export const OPENCODE_PERMISSION = process.env["OPENCODE_PERMISSION"]
  export const OPENCODE_DISABLE_DEFAULT_PLUGINS = truthy("OPENCODE_DISABLE_DEFAULT_PLUGINS")
  export const OPENCODE_DISABLE_LSP_DOWNLOAD = OPENCODE_SAFE_MODE || truthy("OPENCODE_DISABLE_LSP_DOWNLOAD")
  ...
  export const OPENCODE_ALLOWED_HOSTS = process.env["OPENCODE_ALLOWED_HOSTS"]
  export const OPENCODE_DISABLE_DYNAMIC_INSTALLS =
    OPENCODE_SAFE_MODE || truthy("OPENCODE_DISABLE_DYNAMIC_INSTALLS")
  export const OPENCODE_DISABLE_REMOTE_INSTRUCTIONS =
    OPENCODE_SAFE_MODE || truthy("OPENCODE_DISABLE_REMOTE_INSTRUCTIONS")
  export const OPENCODE_DISABLE_REMOTE_MCP = truthy("OPENCODE_DISABLE_REMOTE_MCP")
