...
export NO_PROXY="${NO_PROXY:+$NO_PROXY,}127.0.0.1,localhost,::1,uv.tool.huawei.com,mirrors.tools.huawei.com,__OPENCODE_INTRANET_HOST__,__OPENCODE_INTRANET_HOST__:4000"
export no_proxy="${no_proxy:+$no_proxy,}127.0.0.1,localhost,::1,uv.tool.huawei.com,mirrors.tools.huawei.com,__OPENCODE_INTRANET_HOST__,__OPENCODE_INTRANET_HOST__:4000"
